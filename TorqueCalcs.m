function [TorqueHip,TorqueKnee,TorqueSplay] = TorqueCalcs(HipAngle,KneeAngle,SplayAngle)
    UpperLegLength = 0.4; %Units in m
    LowerLegLength = 0.4; %Units in m
    ...
    BodyForce = (TotalWeight * Gravity) / 2;
